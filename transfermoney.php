...
<div class="main_div">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:skyblue;border-radius:10px;color:white" >
              <form method="POST">  
                                              
 <?php
include 'connection.php';
$ids=$_GET['idtransfer'];
$showquery="select * from `customerdetails` where ID=($ids) ";
...
?> 
                    ...
                    <h3>Transfer Details</h3>
                        ...
                        <img src="images/show.png" style="width:130px;height:60px;">
                    </div>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/trans.jpg" style="width:320px;height:220px;margin-top:40px;">
...
if(isset($_POST['submit']))
{
    ...
    $ids=$_GET['idtransfer'];
    $senderquery="select * from `customerdetails` where ID=$ids ";
    ...
    //receiverquery
    $receiverquery="select * from `customerdetails` where Email='$Receiver_email' ";
    ...
    if($arrdata['amount'] >= $Sender)
    {
      ...
      $increase_receiver=$receiver_arr['amount'] + $Sender;
       $query="UPDATE `customerdetails` SET `ID`=$ids,`Amount`= $decrease_sender  where `ID`=$ids ";
       $rec_query="UPDATE`customerdetails` SET `ID`=$id_receiver,`Amount`= $increase_receiver where  `ID`=$id_receiver ";
